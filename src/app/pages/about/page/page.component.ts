...
export class PageComponent {
  ...
  accordionData = [
    ...
    },
    {
      ...
      content:
        'Users can access a data dashboard designed by healthcare experts to address their specific surveillance data needs.' +
    ...
    },
    {
      ...
      content:
        'Utilizing state-of-the-art analytics tools, SHIELD transforms raw datasets in different formats into actionable insights. This enables the Ministry of Health (MOH), its partners, and stakeholders to identify trends, ' +
    ...
    },
    {
      ...
      content:
        'SHIELD platform automatically connects to source data systems, thus offering real-time monitoring capabilities. This allows health professionals to track health indicators, monitor disease prevalence, and respond promptly to emerging health threats.',
    },
    {
      id: 4,
      ...
      content:
        'SHIELD prioritizes data security and privacy, ensuring compliance with the highest confidentiality and data protection standards. Our secure exchange protocols facilitate safe and efficient data sharing among authorized stakeholders.',
    },
    {
      id: 5,
      title: 'Resources',
      ...
      content:
        'The SHIELD platform provides an array of resources tailored to meet the diverse needs of health surveillance professionals. This includes guidelines, standard operation procedures, frameworks, etc. The resources can be found on the Resource page.',
    },
  ];
}
